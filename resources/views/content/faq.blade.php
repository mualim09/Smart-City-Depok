...
<div class="content">
  ...
  <div class="form-group">
    ...
    {{Form::textarea('answer', $faq->answer,['class' => 'form-control', 'style' => 'background-color: white; color:black' ])}}
  </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <label>Pertanyaan</label>
                  <input type="text" class="form-control" name="question" placeholder="Apa itu Sippkling">
                </div>
                <div class="form-group">
                  <label>Deskripsi</label>
                  <textarea class="form-control" rows="5" name="answer" placeholder="SipKling adalah sebuah sistem pendataan dan analisis lingkungan yang adadidaerah Depok."></textarea>
                </div>
              </div>
              <div class="modal-footer">

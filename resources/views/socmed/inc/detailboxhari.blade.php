                  ...
                  <div class="col-md-4 right-side-information-grafik">
                   <div class="col-xs-6">
                    ...
                    @if(($tgl_positif2>$tgl_negatif2)||($tgl_positif2=$tgl_negatif2))
                      <p style="font-size: 30px;margin-top: 6px;">{{ round(($tgl_positif2/($tgl_positif2 + $tgl_netral2 + $tgl_negatif2)*100) , 2)}} %</p>
                    </div>
                    <div class="col-xs-6" style="text-align: right;padding-top: 10px">
                      <i class="fa fa-smile-o fa-4x" style="color: #1ba1ed"></i>
                    </div>
                    @elseif($tgl_positif2<$tgl_negatif2)
                      <p style="font-size: 30px;margin-top: 6px;">{{ round(($tgl_negatif2/($tgl_positif2 + $tgl_netral2 + $tgl_negatif2)*100) , 2)}} %</p>
                    </div>
                    <div class="col-xs-6" style="text-align: right;padding-top: 10px">
                      <i class="fa fa-frown-o fa-4x" style="color: #fd79a8"></i>
                    </div>
                    @elseif((($tgl_positif2+$tgl_netral2+$tgl_negatif2) == 0))

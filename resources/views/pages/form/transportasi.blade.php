        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="#angkot" data-toggle="tab">Angkot</a></li>
              <li><a href="#jasapengiriman" data-toggle="tab">Jasa Pengiriman</a></li>          
            </ul>
            <div class="box-body border-radius-none">
              <div class="tab-content">
                ...
                <!--KESEHATAN-->
{{-- ============================================================================================================== --}}
                <div class="tab-pane active" id="angkot">    

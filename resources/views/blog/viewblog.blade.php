...
<body class="w3-white">
  ...
  <div class="w3-top">
    <div class="w3-bar w3-padding-16" id="myNavbar">
      ...
      <div class=" w3-right w3-display-right" style="margin-right:3em;letter-spacing:1px">
        <div class="w3-bar-item w3-hide-small" style="padding-top:1.5em;">BLOG</div>
  ...
  <div class="w3-content w3-padding-64" style="    padding-top: 130px!important;;max-width:1100px">
    <img src="{{ asset ("storage/img_blog/$blog->image") }}" style="width:100%; height:400px" data-ix="scale-on-scroll">
    <h2 data-ix="scale-on-scroll">{{ $blog -> judul }}</h2>
    <div class="w3-row">
      <div class="w3-half" data-ix="scale-on-scroll">
        <p class="w3-text-grey w3-small" style="margin:0"> {{ $blog->created_at }} </p>
      </div>
    ...
    <hr>
    <p data-ix="scale-on-scroll" class="w3-justify" style="line-height: 2em">{!! $blog->isi !!}</p>
  </div>

 <div class="w3-container w3-light-gray">
    <div class="w3-content w3-padding-64">
      <h2 class="f_bold w3-center" data-ix="scale-on-scroll">BLOG LAINNYA</h2>
      <p class="w3-opacity w3-center" data-ix="scale-on-scroll"><i>Cari tahu blog lainnya di Kota Depok</i></p><br>
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
      @foreach($cakblogs as $cak)
        <div class="w3-third w3-margin-bottom" data-ix="scale-on-scroll">
          <img src="{{ asset ("storage/img_blog/$cak->image") }}" style="width:100%; height:300px">
          <div class="w3-container w3-white">
            <p><b>{{ $cak -> judul }}</b></p>
            <p class="w3-opacity">{{ $cak->created_at }}</p>
            <a href="/event/{{ $cak -> judul }}" style="text-decoration: none;"><button class="w3-button w3-black w3-margin-bottom">Selengkapnya</button></a>
          </div>
        </div>
      @endforeach
      </div>
